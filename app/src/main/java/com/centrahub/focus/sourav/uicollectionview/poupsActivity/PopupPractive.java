...
public class PopupPractive extends AppCompatActivity implements View.OnClickListener {
...
//        showSortPopup(PopupPractive.this, point,iWidth,iHeight);
        Toast.makeText(PopupPractive.this, ((TextView) view).getText().toString() + "  : clicked", Toast.LENGTH_SHORT).show();
