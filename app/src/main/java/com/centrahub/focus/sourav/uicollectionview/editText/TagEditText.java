...
public class TagEditText extends android.support.v7.widget.AppCompatEditText {
    ...
    public View createTokenView(String text) {
        ...
        gDrawable.setColor(getResources().getColor(R.color.grayLt));
        gDrawable.setStroke(1, Color.LTGRAY);
        gDrawable.setCornerRadius(100);
        float[] radii=new float[]{5f,5f,5f,5f,5f,5f,5f,5f};

*/
        l.setBackgroundResource(R.drawable.bordered_rectangle_rounded_corners);
//        l.setBackground(gDrawable);
        ...
        l.addView(im);
        im.setImageResource(R.drawable.ic_cancel_black_24dp);
